...
Only versions listed as supported in the latest release receive fixes. The currently supported prerelease is `v1.0.0-beta.5`; earlier beta builds should be upgraded before reporting a defect.
