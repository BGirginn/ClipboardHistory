...
- Data Protection Keychain and login Keychain behavior require correctly signed interactive builds; unsigned tests use isolated keys and fail closed where appropriate.
