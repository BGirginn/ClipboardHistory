...
- Application Lock hides Clipboard and Notes and blocks their actions, but it does not encrypt open Clipboard storage. Clipboard capture therefore pauses while the application is locked.
